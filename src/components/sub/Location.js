...
/*
  ...
  3. 애플리케이션 추가
  3.1 내 애플리케이션 > 추가 > JavaScript 키 복사(본인 키)
...
const Location = () => {
  ...
  // 좌표 배열 요소의 인덱스 번호 : 최초 0번으로 보여주기
  const [idx, setIdx] = useState(0);

  //지도를 담을 영역의 DOM 레퍼런스
  // var container = document.getElementById("map");
  const container = useRef(null);
  // var btns = document.getElementById(".btnSet > ul");
  ...
  useEffect(() => {
    ...
    // btns 의 current.children 중 idx 에 해당하는 요소만
    // on 클래스 적용해보세요
